...
# 2 초	128 MB	187234	75714	52301	39.004%
# 문제
...
# 스택을 이용해 그 수열을 만들 수 있는지 없는지, 있다면 어떤 순서로 push와 pop 연산을 수행해야
# 하는지를 알아낼 수 있다. 이를 계산하는 프로그램을 작성하라.
...
# 출력
# 입력된 수열을 만들기 위해 필요한 연산을 한 줄에 한 개씩 출력한다. push연산은 +로,
# pop 연산은 -로 표현하도록 한다. 불가능한 경우 NO를 출력한다.
